        ...
        <div class="card-body ">
            ...
            <form class="row g-3" action="/clientes/{{$cliente->id}}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="proyecto" class="form-control" id="proyecto" value="{{$cliente->proyecto}}"
                        tabindex="1" required>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="dir_numExt" class="form-control" id="dir_numExt" value="{{$cliente->dir_numExt}}"
                        tabindex="8" required>
                </div>
                <div class="col-md-3">
                    <label for="dir_numInt" class="form-label">Num Int</label>
                    <input type="text" name="dir_numInt" class="form-control" id="dir_numInt" value="{{$cliente->dir_numInt}}"
                        tabindex="9" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <!-- Botton -->
                    <a href="" class="btn btn-secondary" tabindex="11">Cancelar</a>
