                        ...
                        <form class="row g-3" action="/clientes" method="POST">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="proyecto" class="form-control" id="proyecto"
                                    placeholder="Area 51" tabindex="1" required>
                            </div>
                            <div class="col-md-12">
                                <label for="nombre" class="form-label">Nombre</label>
                                <input type="text" name="nombre" class="form-control" id="nombre"
                                    placeholder="Esteban" tabindex="2" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="rfc" class="form-control" id="rfc"
                                    placeholder="SAME900115" tabindex="5" required>
                            </div>
                            <div class="col-12">
